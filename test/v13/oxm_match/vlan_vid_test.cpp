...
BOOST_AUTO_TEST_SUITE(vlan_vid_test)
    ...
    BOOST_AUTO_TEST_SUITE(equality)
      ...
      {
        auto const sut1 = match::vlan_vid{proto::OFPVID_PRESENT | 2};
        auto const sut2 = match::vlan_vid{proto::OFPVID_PRESENT | 2};

        BOOST_TEST((sut1 == sut2));
      }
      BOOST_AUTO_TEST_CASE(true_if_value_and_mask_are_same)
      {
        auto const sut1 = match::vlan_vid{proto::OFPVID_PRESENT | 3, 0x00ff};
        auto const sut2 = match::vlan_vid{proto::OFPVID_PRESENT | 3, 0x00ff};
      ...
      {
        auto const sut1 = match::vlan_vid{proto::OFPVID_PRESENT | 2};
        auto const sut2 = match::vlan_vid{proto::OFPVID_PRESENT | 3};
      ...
      {
        auto const sut1 = match::vlan_vid{proto::OFPVID_PRESENT | 3, 0x00ff};
        auto const sut2 = match::vlan_vid{proto::OFPVID_PRESENT | 4, 0x00ff};
      ...
      {
        auto const sut1 = match::vlan_vid{proto::OFPVID_PRESENT | 3, 0x00ff};
        auto const sut2 = match::vlan_vid{proto::OFPVID_PRESENT | 3, 0xff00};
      ...
      {
        auto const sut1 = match::vlan_vid{proto::OFPVID_PRESENT | 3, 0x00ff};
        auto const sut2 = match::vlan_vid{proto::OFPVID_PRESENT | 4, 0xff00};

        BOOST_TEST((sut1 != sut2));
      }
      BOOST_AUTO_TEST_CASE(false_if_equivalent_but_one_has_no_mask_and_another_has_mask)
      {
        auto const sut1 = match::vlan_vid{proto::OFPVID_PRESENT | 0x0400};
        auto const sut2 = match::vlan_vid{proto::OFPVID_PRESENT | 0x0400, 0xffff};
