...
BOOST_AUTO_TEST_SUITE(ipv6_src_test)
    ...
    BOOST_AUTO_TEST_SUITE(equality)
      ...
      {
        auto const sut1 = match::ipv6_src{"ff01::1"_ipv6};
        auto const sut2 = match::ipv6_src{"ff01::1"_ipv6};

        BOOST_TEST((sut1 == sut2));
      }
      BOOST_AUTO_TEST_CASE(true_if_value_and_mask_are_same)
      {
        auto const sut1 = match::ipv6_src{"ff01::1"_ipv6, 8};
        auto const sut2 = match::ipv6_src{"ff01::1"_ipv6, 8};
      ...
      {
        auto const sut1 = match::ipv6_src{"ff01::1"_ipv6};
        auto const sut2 = match::ipv6_src{"ff02::1"_ipv6};
      ...
      {
        auto const sut1 = match::ipv6_src{"ff01::1"_ipv6, 8};
        auto const sut2 = match::ipv6_src{"ff02::1"_ipv6, 8};
      ...
      {
        auto const sut1 = match::ipv6_src{"ff01::1"_ipv6, 8};
        auto const sut2 = match::ipv6_src{"ff01::1"_ipv6, 16};
      ...
      {
        auto const sut1 = match::ipv6_src{"ff01::1"_ipv6, 8};
        auto const sut2 = match::ipv6_src{"ff02::1"_ipv6, 16};

        BOOST_TEST((sut1 != sut2));
      }
      BOOST_AUTO_TEST_CASE(false_if_equivalent_but_one_has_no_mask_and_another_has_mask)
      {
        auto const sut1 = match::ipv6_src{"::1"_ipv6};
        auto const sut2 = match::ipv6_src{"::1"_ipv6, 128};
