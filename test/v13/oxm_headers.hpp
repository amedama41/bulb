#ifndef CANARD_NET_OFP_V13_TEST_OXM_HEADERS_HPP
...
constexpr auto OXM_OF_IN_PORT
    = OXM_HEADER  (0x8000, canard::net::ofp::v13::protocol::OFPXMT_OFB_IN_PORT, 4);
constexpr auto OXM_OF_IN_PORT_W
    = OXM_HEADER_W(0x8000, canard::net::ofp::v13::protocol::OFPXMT_OFB_IN_PORT, 4);
...
constexpr auto OXM_OF_METADATA_W
    = OXM_HEADER_W(0x8000, canard::net::ofp::v13::protocol::OFPXMT_OFB_METADATA, 8);
constexpr auto OXM_OF_ETH_DST
    = OXM_HEADER  (0x8000, canard::net::ofp::v13::protocol::OFPXMT_OFB_ETH_DST, 6);
constexpr auto OXM_OF_ETH_DST_W
    = OXM_HEADER_W(0x8000, canard::net::ofp::v13::protocol::OFPXMT_OFB_ETH_DST, 6);
constexpr auto OXM_OF_ETH_SRC
    = OXM_HEADER  (0x8000, canard::net::ofp::v13::protocol::OFPXMT_OFB_ETH_SRC, 6);
constexpr auto OXM_OF_ETH_SRC_W
    = OXM_HEADER_W(0x8000, canard::net::ofp::v13::protocol::OFPXMT_OFB_ETH_SRC, 6);
...
constexpr auto OXM_OF_VLAN_VID_W
    = OXM_HEADER_W(0x8000, canard::net::ofp::v13::protocol::OFPXMT_OFB_VLAN_VID, 2);
...
constexpr auto OXM_OF_IPV4_SRC_W
    = OXM_HEADER_W(0x8000, canard::net::ofp::v13::protocol::OFPXMT_OFB_IPV4_SRC, 4);
constexpr auto OXM_OF_IPV4_DST
    = OXM_HEADER  (0x8000, canard::net::ofp::v13::protocol::OFPXMT_OFB_IPV4_DST, 4);
constexpr auto OXM_OF_IPV4_DST_W
    = OXM_HEADER_W(0x8000, canard::net::ofp::v13::protocol::OFPXMT_OFB_IPV4_DST, 4);
...
constexpr auto OXM_OF_ARP_SPA_W
    = OXM_HEADER_W(0x8000, canard::net::ofp::v13::protocol::OFPXMT_OFB_ARP_SPA, 4);
constexpr auto OXM_OF_ARP_TPA
    = OXM_HEADER  (0x8000, canard::net::ofp::v13::protocol::OFPXMT_OFB_ARP_TPA, 4);
constexpr auto OXM_OF_ARP_TPA_W
    = OXM_HEADER_W(0x8000, canard::net::ofp::v13::protocol::OFPXMT_OFB_ARP_TPA, 4);
...
constexpr auto OXM_OF_IPV6_SRC_W
    = OXM_HEADER_W(0x8000, canard::net::ofp::v13::protocol::OFPXMT_OFB_IPV6_SRC, 16);
constexpr auto OXM_OF_IPV6_DST
    = OXM_HEADER  (0x8000, canard::net::ofp::v13::protocol::OFPXMT_OFB_IPV6_DST, 16);
constexpr auto OXM_OF_IPV6_DST_W
    = OXM_HEADER_W(0x8000, canard::net::ofp::v13::protocol::OFPXMT_OFB_IPV6_DST, 16);
constexpr auto OXM_OF_IPV6_FLABEL
    = OXM_HEADER  (0x8000, canard::net::ofp::v13::protocol::OFPXMT_OFB_IPV6_FLABEL, 4);
constexpr auto OXM_OF_IPV6_FLABEL_W
    = OXM_HEADER_W(0x8000, canard::net::ofp::v13::protocol::OFPXMT_OFB_IPV6_FLABEL, 4);
...
constexpr auto OXM_OF_PBB_ISID_W
    = OXM_HEADER_W(0x8000, canard::net::ofp::v13::protocol::OFPXMT_OFB_PBB_ISID, 3);
constexpr auto OXM_OF_TUNNEL_ID
    = OXM_HEADER  (0x8000, canard::net::ofp::v13::protocol::OFPXMT_OFB_TUNNEL_ID, 8);
constexpr auto OXM_OF_TUNNEL_ID_W
    = OXM_HEADER_W(0x8000, canard::net::ofp::v13::protocol::OFPXMT_OFB_TUNNEL_ID, 8);
constexpr auto OXM_OF_IPV6_EXTHDR
    = OXM_HEADER  (0x8000, canard::net::ofp::v13::protocol::OFPXMT_OFB_IPV6_EXTHDR, 2);
constexpr auto OXM_OF_IPV6_EXTHDR_W
    = OXM_HEADER_W(0x8000, canard::net::ofp::v13::protocol::OFPXMT_OFB_IPV6_EXTHDR, 2);

}

#endif // CANARD_NET_OFP_V13_TEST_OXM_HEADERS_HPP
