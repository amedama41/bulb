...
namespace instructions {
  ...
  {
  public:
    using ofp_type = protocol::ofp_instruction_write_metadata;
  ...
  private:
    ...
    explicit write_metadata(ofp_type const& instruction_write_metadata) noexcept
  ...
  private:
    ofp_type instruction_write_metadata_;
  };
